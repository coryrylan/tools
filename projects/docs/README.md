...
The documentation site for [`@coryrylan/tools`](../tools/). Not published or released - it's built and deployed as a static site to GitHub Pages.
...
| `pnpm run build` | Generate the production site into `dist/`, including the rule pages, rules index, and `llms.txt` generated from `../tools`'s rule docs |
